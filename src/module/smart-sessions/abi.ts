...
export const abi = [
  ...
  {
    type: "function",
    name: "areUserOpZkPoliciesEnabled",
    inputs: [
      {
        name: "account",
        type: "address",
